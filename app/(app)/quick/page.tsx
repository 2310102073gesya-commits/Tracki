...
export default function QuickInputPage() {
  ...
  const toggleListen = () => {
    if (isListening) {
      ...
      if (!recognitionRef.current) {
        alert('Maaf, browser Anda tidak mendukung fitur Suara. Gunakan Chrome atau Edge.');
        return;
      }
      setText('');
      setResult(null);
  ...
  return (
    <div className="page active" id="page-quick">
      ...
      <div className="page-sub">Ketik atau ngomong, AI akan mencatat otomatis</div>
      ...
      <div className="g2">
        <div>
          <div className="card" style={{ marginBottom: '14px' }}>
            ...
            <div style={{ position: 'relative', marginBottom: '14px' }}>
              ...
              <button 
                ...
                style={{
                  ...
                  right: '10px',
                  bottom: '10px',
                  background: isListening ? 'var(--pink)' : 'var(--blue-dim)',
                  color: isListening ? 'white' : 'var(--blue)',
                  border: 'none',
                  borderRadius: '50%',
                  width: '36px',
                  height: '36px',
            ...
            {isListening && (
              <div style={{ fontSize: '12px', color: 'var(--pink)', marginBottom: '14px', textAlign: 'center', fontWeight: 500 }}>
